...
@section('content')
<div class="card">
    <div class="card-header"><strong>Ubah Keterangan Barang</strong>
    ...
    <div class="div card-body card-block">
        <form action="{{route('products.update',$item->id)}}" method="POST">
            ...
            <div class="form-group">
                <label for="name" class="label form-control-label">Nama Barang</label>
            ...
            <div class="form-group">
                <label for="type" class="label form-control-label">Tipe Barang</label>
            ...
            <div class="form-group">
                <label for="description" class="label form-control-label">Deskrisi Barang</label>
            ...
            <div class="form-group">
                <label for="price" class="label form-control-label">Harga Barang</label>
            ...
            <div class="form-group">
                <label for="type" class="label form-control-label">Jumlah  Barang</label>
